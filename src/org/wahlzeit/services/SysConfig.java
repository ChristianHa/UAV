...
public class SysConfig extends AbstractConfig {
	...
	public SysConfig(String myRootDir) {
		...
		doSetValue(SysConfig.DB_CONNECTION, "jdbc:postgresql://localhost:5432/happ");
		doSetValue(SysConfig.DB_USER, "happ");
//		doSetValue(SysConfig.DB_PASSWORD, "wahlzeit");
		doSetValue(SysConfig.DB_PASSWORD, "OPc7nBxoKjNkpHxP");
	}
